...
## 7) RAG chat endpoint (ai-service)
After KB_Graph is built, start ai-service and call the graph-based RAG endpoint:
...
- recommendations: personalized recommendation fallback from ai-service
