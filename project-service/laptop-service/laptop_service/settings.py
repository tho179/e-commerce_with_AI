...
SECRET_KEY = os.getenv('DJANGO_SECRET_KEY', 'laptop-service-dev-key')
DEBUG = True
ALLOWED_HOSTS = ['*']
...
MIDDLEWARE = [
    ...
    'laptop_service.service_auth_middleware.ServiceAuthMiddleware',
...
DATABASES = {
    'default': {
        ...
        'HOST': os.getenv('DB_HOST', 'laptop-db'),
